...
public class InvoiceGenerator
{
    ...
    {
        // Đường dẫn lưu tệp PDF
        string directoryPath = @"E:\FPT\DuAn1\XuatFile";
        string filePath = Path.Combine(directoryPath, "HoaDon.pdf");
        ...
        infoTable.AddCell(CreateCell("Số hóa đơn: INV-001", font, TextAlignment.RIGHT));
        ...
        Console.WriteLine("Invoice PDF created at: " + filePath);
    }
